...
typedef enum
{
    ...
    gMPibPanId_c                                = 0x0101,    /*!< The 16-bit identifier of the PAN on which the device is operating. If this value is 0xffff, the device is not associated. */
...
typedef PACKED_STRUCT macTimeslotTemplate_tag
{
    ...
    uint16_t macTsCCAOffset;        /*!< The time between the beginning of timeslot and start of CCA operation, in �s */
    uint16_t macTsCCA;              /*!< Duration of CCA, in �s */
    uint16_t macTsTxOffset;         /*!< The time between the beginning of the timeslot and the start of frame transmission, in �s */
    uint16_t macTsRxOffset;         /*!< Beginning of the timeslot to when the receiver shall be listening, in �s */
    uint16_t macTsRxAckDelay;       /*!< End of frame to when the transmitter shall listen for Acknowledgment, in �s */
    uint16_t macTsTxAckDelay;       /*!< End of frame to start of Acknowledgment, in �s */
    uint16_t macTsRxWait;           /*!< The time to wait for start of frame, in �s */
    uint16_t macTsAckWait;          /*!< The minimum time to wait for start of an Acknowledgment, in �s */
    uint16_t macTsRxTx;             /*!< Transmit to Receive turnaround, in �s */
    uint16_t macTsMaxAck;           /*!< Transmission time to send Acknowledgment, in �s */
    uint16_t macTsMaxTx;            /*!< Transmission time to send the maximum length frame, in �s */
